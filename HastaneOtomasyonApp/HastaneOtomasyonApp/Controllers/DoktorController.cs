...
namespace HastaneOtomasyonApp.Controllers
{
    public class DoktorController : Controller
    {
        ...
        public DoktorController(HastaneOtomasyonDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DoktorID,DoktorTamAdı,MobilNO,TCNO")] Doktor doktor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoktorID,DoktorTamAdı,MobilNO,TCNO")] Doktor doktor)
        {
