...
namespace HastaneOtomasyonApp.Controllers
{
    public class HastaController : Controller
    {
        ...
        public HastaController(HastaneOtomasyonDBContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Hasta.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("HastaID,HastaTamAdı,MobilNO,TCNO")] Hasta hasta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HastaID,HastaTamAdı,MobilNO,TCNO")] Hasta hasta)
        {
            if (id != hasta.HastaID)
            {
                return NotFound();
        ...
        {
            return _context.Hasta.Any(e => e.HastaID == id);
        }
    }
}
