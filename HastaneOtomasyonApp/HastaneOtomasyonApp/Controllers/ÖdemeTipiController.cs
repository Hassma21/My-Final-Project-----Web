...
namespace HastaneOtomasyonApp.Controllers
{
    public class ÖdemeTipiController : Controller
    {
        ...
        public ÖdemeTipiController(HastaneOtomasyonDBContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.ÖdemeTipi.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ödemeTipi = await _context.ÖdemeTipi
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ödemeTipi = await _context.ÖdemeTipi.FindAsync(id);
            if (ödemeTipi == null)
            {
                return NotFound();
            }
        ...
        {
            var ödemeTipi = await _context.ÖdemeTipi.FindAsync(id);
            _context.ÖdemeTipi.Remove(ödemeTipi);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.ÖdemeTipi.Any(e => e.ÖdemeTipiID == id);
        }
    }
}
